...
const TranscribeForm: React.FC = () => {
  return <div className="w-full bg-opacity-30 backdrop-blur-sm rounded-2xl p-6 mb-16 bg-[#247bfd] relative z-0">
      <div className="flex flex-col md:flex-row md:items-center relative">
        ...
        <Button className="bg-gradient-to-r from-[#247BFD] to-[#0c34af] hover:from-[#1e69d9] hover:to-[#0a2d99] text-white font-semibold text-lg py-2 px-8 rounded-md h-[60px] flex items-center gap-3 whitespace-nowrap shadow-md mt-3 md:mt-0 md:absolute md:right-0 md:top-0 md:w-[280px]">
